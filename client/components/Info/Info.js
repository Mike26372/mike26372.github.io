...
class Info extends Component {
  ...
  render() {
    ...
    let githubIcon = `fa fa-github-square ${infoStyles.icon} ${styles.smallIcon}`;
    let linkedInIcon = `fa fa-linkedin-square ${infoStyles.icon} ${styles.smallIcon}`;
    let angelListIcon = `fa fa-angellist ${infoStyles.icon} ${styles.smallIcon}`;
    let documentIcon = `fa fa-file-text-o ${infoStyles.icon} ${styles.smallIcon}`;
        ...
        <div className={contentStyle}>
          <div className={rowsStyle}>
            ...
            <div className={row2ColumnsStyle}>
              <a className={infoContainerStyle} href="mailto:tutt.michael@gmail.com">
                <i className={mailIcon} aria-hidden="true"></i>
                <span className={infoStyle}>Email Me</span> 
              </a>
              <a className={infoContainerStyle} href="https://github.com/Mike26372" target="_blank">
                <i className={githubIcon} aria-hidden="true"></i>
                <span className={infoStyle}>GitHub</span> 
              </a>
              <a className={infoContainerStyle} href="https://www.linkedin.com/in/michaeltutt/" target="_blank">
                <i className={linkedInIcon} aria-hidden="true"></i>
                <span className={infoStyle}>LinkedIn</span> 
              </a>
              <a className={infoContainerStyle} href="https://angel.co/michael-tutt" target="_blank">
